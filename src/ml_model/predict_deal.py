...
def predict_deal(product_data:Product):
    ...
    if 'discount_percentage' not in product_data.columns:
        product_data['discount_percentage'] = (product_data['product_discount'] / product_data['product_price']) * 100
    
    if 'discount_amount' not in product_data.columns:
        product_data['discount_amount'] = product_data['product_price'] - product_data['product_discount']
