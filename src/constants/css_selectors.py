...
PRODUCT_DETAILS: Dict[Websites, Dict[ProductKey, List[str]]] = {
    Websites.AMAZON: {
        ...
        "average_rating": ["span.a-icon-alt"],
    ...
    Websites.FLIPKART: {
        ...
        "average_rating": ["div.XQDdHH"],
        "review_count": ["span.Wphh3N"],
    ...
    Websites.MYNTRA: {
        ...
        "average_rating": ["div.product-ratingsContainer span"],
        "review_count": ["div.product-ratingsCount"],
